...
• Full-page translation does not run on restricted pages (chrome://, browser internal pages, etc.); selection translation there is routed to the side panel (Chromium 114+)
