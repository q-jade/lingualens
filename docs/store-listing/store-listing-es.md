...
Local
• Ollama (preajuste por defecto) — http://localhost:11434
• LM Studio — Usa la API local nativa de LM Studio

Preajustes cloud
• OpenAI — api.openai.com
• DeepSeek — api.deepseek.com
• DeepL — Endpoint de API gratuito o Pro
...
Si los atajos entran en conflicto con otras extensiones, reasigna los atajos de LinguaLens en chrome://extensions/shortcuts.
...
Consejo para Ollama: ejecuta `ollama pull llama3` e inicia Ollama con OLLAMA_ORIGINS="chrome-extension://*" si el navegador no puede conectarse.
...
• La traducción de página completa no funciona en páginas restringidas (chrome://, páginas internas del navegador, etc.); la traducción de selección se enruta al panel lateral (Chromium 114+)
